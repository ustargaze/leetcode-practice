...
枚举所有的可能性，通过 Floyd 算法计算出两点之间的最短路，确保保留的所有节点直接都可访问且最短路小于等于 maxDistance。

枚举可以通过二进制简化。

Floyd 代码不会写，参考[两种方法：二进制枚举 / 状压 DP（Python/Java/C++/Go）](https://leetcode.cn/problems/number-of-possible-sets-of-closing-branches/solutions/2560722/er-jin-zhi-mei-ju-floydgao-xiao-xie-fa-f-t7ou)。
