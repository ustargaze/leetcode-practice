...
参考[两种方法：二分答案+正序/逆序（Python/Java/C++/Go）](https://leetcode.cn/problems/earliest-second-to-mark-indices-i/solutions/2653101/er-fen-da-an-pythonjavacgo-by-endlessche-or61)
